// Code generated by "enumer -type=Environment -json -trimprefix Environment -transform=snake -output environment_enumer.go -comment app environment"; DO NOT EDIT.
